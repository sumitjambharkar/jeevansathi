    ...
    const respone = await fetch(
      "https://marriageorbit-backend-api.herokuapp.com/send-email",
      {
        ...
        body: JSON.stringify({
          ...
          message: `Hi ${showData.displayName} ${
            user.displayName
        ...
        <div className="row">
          <div className="col-md-8 mt-3">
            <div className="line">
              ...
              <div className="personal">
                ...
                <div className="col-12">
                  ...
                  <div className="col-md-6">
                    ...
                    <br />
                    <ul>
                      <li><span>Employed In</span></li>
                      <li>{showData.employed}</li>
                    </ul>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                   ...
                   <ul>
                    ...
                    <br />
                    <ul>
                      <li><span>Gothra (maternal)</span></li>
                      <li>Not filled in</li>
                    </ul>
              ...
              <div className="EducationCareer">
                <div className="row">
                  <div className="col-md-12">
                    <div className="career">
                      <p>
                        {" "}
                        <Tooltip title="Desired Partner">
                          <PreviewSharpIcon />
                        </Tooltip>
                        Desired Partner
                      </p>
                  ...
                  <div >
                    <div className="flex">
                      <span>His Preferences</span>---------------
                      <span>6 of 7 matching</span>---------------
                  ...
                  <div className="col-md-12">
                    <div className="Desired">
                      <ul>
                        <li><span>State/City</span></li>
                        <li>
                          Alibag, Hingoli, Indapur, Ulhasnagar, Mangalvedhe
                        </li>
                  ...
                  <div className="col-md-12">
                    <div className="Desired">
                      <ul>
                        ...
                        <li> Rs. 0 and above, $0 and above</li>
              ...
              <div className="row">
                <div className="col-md-3">
                  <div className="similarimg">
                    <img src="https://imagecdn.jeevansathi.com/33594/10/671890919-1668166450.jpeg"></img>
                  </div>
                </div>
                <div className="col-md-9">
                  <ul>
                    <li>27 yrs, 5' 6" ,Mumbai, India</li>
                    <li> Maratha-96 Kuli Maratha</li>
                    <li>B.A</li>
                    <li>Rs. 3 - 4 Lakh per Annum</li>
                  </ul>
                </div>
